  ...
  function renderComponentRoot(instance) {
    ...
    try {
      if (vnode.shapeFlag & 4) {
        ...
        result = normalizeVNode(render3.length > 1 ? render3(props2, process.env.NODE_ENV !== "production" ? {
          get attrs() {
            markAttrsAccessed();
            return attrs;
          },
  ...
  class VueElement extends BaseClass {
    ...
    _resolveDef() {
      ...
      const resolve2 = (def2) => {
        ...
        const hasOptions = !isArray(props2);
...
`);
  ...
  function processSlotOutlet(node, context) {
    ...
    if (nonNameProps.length > 0) {
      const { props: props2, directives } = buildProps(node, context, nonNameProps, false, false);
      slotProps = props2;
...
${codeFrame}` : message);
  ...
  const IButton = vue.defineComponent({
    name: "IButton",
    props,
    setup(props2, {
      slots
      ...
      `
        ...
        "class": `i-ic-baseline-${props2.icon} p3`
      }, null) : "", slots.default ? slots.default() : "\u6309\u94AE"]);
    }
  });
  const _sfc_main = {
    name: "SFCButton"
...
//# sourceMappingURL=x-components-library.umd.js.map
